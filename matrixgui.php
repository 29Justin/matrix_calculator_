...
<div class="topnav">
  ...
  <a class="active" href="http://localhost/matrixgui.php">Matrix</a>
</div>

<p align="right">
<a href="http://localhost/matrixgui%20light%20mode.php" onclick="modeshift()"><button class="b1" role="button">Light Mode</button></a>
</p>
...
<h3 style="background-color:#2c2f33; color:#99aab5;">
<?php
...
<p align="right" style="font-family: Common Pixel;">matrix calculator (Dark Mode) - release: beta - v2.7</p>
</body>
</html>